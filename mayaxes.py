...
=== Inputs ===
'title'         Figure title text (default = 'TITLE')
...
def mayaxes(title_string='TITLE',xlabel='X',ylabel='Y',zlabel='Z',title_size=25,ticks=7,font_scaling=0.7):
    ...
    from mayavi.mlab import axes,title,gcf
...
def test_mayaxes():
    ...
    mayaxes('Figure 1: Diminishing polar cosine series','X data','Y data','Z data')
